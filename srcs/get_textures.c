...
/*   Updated: 2025/02/12 14:31:43 by ankammer         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	get_texture(t_cub3d *cub3d, char **tmp_texture)
{
	...
	{
		if (cub3d->coltex > 6)
			return (free_strs(tmp_texture), msg_error(ERRDUPTEX, cub3d), 1);
		return (free_strs(tmp_texture), msg_error(ERRCOLTEX, cub3d), 1);
	}
	return (0);
}
